...
def locateReticule(imagePath, param1_list, param2_list, coords, *color_spaces):
    ...
    if centers:
        ...
        distance = euclidean_distance(coords, avg_center)
        print(f"Distance between {coords} and center of averaged circle: {distance:.2f}")
    else:
...
#coords = (493, 330)     ##reticule & dot centre coords

locateReticule(image_path, param1_list, param2_list, coords, 'CMY', 'HLS')